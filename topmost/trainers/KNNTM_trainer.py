...
class KNNTMTrainer:
    ...
    def train(self):
        ...
        if self.lr_scheduler:
            self.logger.info("use lr_scheduler")
        ...
        for epoch in tqdm(range(1, self.epochs + 1)):
            ...
            for idx, batch_data in self.dataset.train_dataloader:
                is_aug = True
                if epoch <= self.p_epoches:
                    is_aug = False

                rst_dict = self.model(idx, batch_data, is_aug)
