...
def train_model(dataset_name, model_name, num_topics, num_clusters, batch_size, epochs, 
                ...
                global_dir=None, sinkhorn_max_iter=100,
                alpha_noise=0.2, alpha_augment=0.5,
    ...
    if model_name == "NewMethod":
        ...
        wandb_name += f"_weight_ot_topic_cluster{weight_ot_topic_cluster}_weight_ot_doc_cluster{weight_ot_doc_cluster}_ECR{weight_loss_ECR}_alpha_noise{alpha_noise}_alpha_augment{alpha_augment}"
