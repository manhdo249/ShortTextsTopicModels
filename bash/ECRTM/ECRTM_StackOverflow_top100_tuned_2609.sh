...
for weight_loss_ECR in 30.0 40.0 20.0 50.0 10.0
do
    for seed in $(seq 0 5)
    do
        ...
        do
            python main.py  \
                ...
                --wandb_name "${MODEL_NAME}_${DATASET}_top${NUM_TOPICS}_weight_loss_ECR${weight_loss_ECR}_lr${lr}_seed${seed}" \
                --verbose
        done
    done
done

for weight_loss_ECR in 30.0 40.0 20.0
do
    for seed in $(seq 0 5)
    do
