...
WANDB_PROJECT=NewMethod_SearchSnippets_top200_cluster30_0902      

for weight_ot_topic_cluster in 0.01 0.1 1 0
do
    for weight_ot_doc_cluster in 0.01 0.1 1 
    do
        for weight_loss_ECR in 30.0 60.0 90.0 
        do
